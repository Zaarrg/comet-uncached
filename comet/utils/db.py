...
async def setup_database():
    try:
        ...
        await database.execute(
            "CREATE TABLE IF NOT EXISTS cache (debridService TEXT, info_hash TEXT, debrid_key TEXT, name TEXT, raw_title TEXT, season INTEGER, episode INTEGER, file_index TEXT, torrent_id TEXT, container_id TEXT, link TEXT, magnet TEXT, uncached BOOLEAN, tracker TEXT, protocol TEXT, data TEXT, timestamp INTEGER)"
        )
        await database.execute(
